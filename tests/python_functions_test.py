...
#   @unittest.skip("delete this line to run the test")
  ...
  def test_volume_of_cube(self):
    cubic_volume = volume_of_cube(3)
    self.assertEqual = (27, cubic_volume)
  ...
  def test_reverse_string(self):
    reversed_string = reverse_string("qwertyuiop")
    self.assertEqual = ("poiuytrewq", reversed_string)
    #add test code here
    pass
  ...
  def test_fahrenheit_to_celsius(self):
    f1_to_c1 = fahrenheit_to_celsius(100.0)
    self.assertEqual (68/1.8, f1_to_c1)

    f2_to_c2 = fahrenheit_to_celsius(50.0)
    self.assertEqual (10.0, f2_to_c2)
    #add test code here
    pass
